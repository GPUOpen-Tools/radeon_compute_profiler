                            ...
                            cl_event*        pEvent)
{
    ...
    if (bNoCounters)
    {
        ...
        if (userEvent != NULL)
        {
            GPULogger::Log(GPULogger::logWARNING, "The profiler does not support user events. clEnqueueNDRangeKernel calls that have a dependency on a user event will not be profiled.\n");
        ...
        {
            GPULogger::Log(GPULogger::logWARNING, "The profiler cannot perform a multi-pass profile with kernels that use SVM kernel args. Use --singlepass to allow profiling these kernels\n");
        ...
        {
            GPULogger::Log(GPULogger::logWARNING, "The profiler cannot perform a multi-pass profile with kernels that use pipe args. Use --singlepass to allow profiling these kernels\n");
