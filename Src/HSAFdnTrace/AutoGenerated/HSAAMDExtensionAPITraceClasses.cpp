...
std::string HSA_APITrace_hsa_amd_memory_pool_allocate::ToString()
{
    ...
    ss << "ptr=" << HSATraceStringUtils::SurroundWithDeRef(StringUtils::ToString(*m_ptr));
    return ss.str();
}
...
std::string HSA_APITrace_hsa_amd_memory_lock::ToString()
{
    ...
    ss << "agent_ptr=" << HSATraceStringUtils::SurroundWithDeRef(StringUtils::ToString(*m_agent_ptr));
    return ss.str();
}
...
std::string HSA_APITrace_hsa_amd_interop_map_buffer::ToString()
{
    ...
    ss << "ptr=" << HSATraceStringUtils::SurroundWithDeRef(StringUtils::ToString(*m_ptr)) << s_strParamSeparator;
    ss << "metadata_size=" << StringUtils::ToStringPtr(m_metadata_size, m_metadata_sizeVal) << s_strParamSeparator;
    ss << "metadata=" << HSATraceStringUtils::SurroundWithDeRef(StringUtils::ToString(*m_metadata));
    return ss.str();
}
...
std::string HSA_APITrace_hsa_amd_ipc_memory_attach::ToString()
{
    ...
    ss << "mapped_ptr=" << HSATraceStringUtils::SurroundWithDeRef(StringUtils::ToString(*m_mapped_ptr));
    return ss.str();
}
