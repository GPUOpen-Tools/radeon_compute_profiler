...
typedef void(*ParserProgress_ReportProgressCallback)(const std::string& strProgressMessage, unsigned int uiCurItem, unsigned int uiTotalItems);
...
public:
    ...
    virtual IOccupancyFileInfoDataHandler* GetOccupancyFileInfoDataHandler(const std::string& occupancyFileName) = 0;
