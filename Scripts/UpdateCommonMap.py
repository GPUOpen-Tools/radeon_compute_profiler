...
downloadMappingWin = {
    "https://github.com/GPUOpen-Tools/GPA/releases/download/v2.22/GPUPerfAPI-2.22.2261.0.zip" : "../Common/Lib/AMD/GPUPerfAPI",
}

downloadMappingLin = {
    "https://github.com/GPUOpen-Tools/GPA/releases/download/v2.22/GPUPerfAPI.2.22.1833-lnx.tgz" : "../Common/Lib/AMD/GPUPerfAPI",
}
